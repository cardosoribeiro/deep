            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">commentable</label>
                            
                            <input type="text" name="commentable" id="commentable" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
